...
const blogPosts: BlogPost[] = [
  {
    ...
    description: "A single building occupies the hillside at Hillview, a historic 240-hectare former sheep farm on Tasmania's Bruny Island...",
  ...
  },
  {
    ...
    description: "We all like to think of ourselves in certain ways. We consider ourselves to be truthful, hard-working, health-conscious...",
    image: "/placeholder.svg?height=200&width=300",
  ...
  },
  {
    ...
    description: "Remote working might not only be feasible but beneficial. Stanford University found that remote employees were 13...",
    image: "/placeholder.svg?height=200&width=300",
  ...
  },
  {
    ...
    description: "The design industry is constantly evolving, but good design is timeless. Learn how to quickly develop an "eye" for UI...",
    image: "/placeholder.svg?height=200&width=300",
  ...
  },
  {
    ...
    description: "Jasmin Chew is a 23-year-old photographer and photo editor from Toronto, Ontario. She has worked with Spotify...",
    image: "/placeholder.svg?height=200&width=300",
  ...
  },
  {
    ...
    description: "Frankie Sullivan explores the 'Design Dilemma' – what happens when best practice UX design clashes with creative...",
    image: "/placeholder.svg?height=200&width=300",
  ...
  },
  {
    ...
    description: "\"I began to notice that there was a sharp contrast between well-made, crafted products and poorly made ones, and...",
    image: "/placeholder.svg?height=200&width=300",
    categories: ["Product", "Research", "Frameworks"],
    link: "#"
  },
  {
    ...
    description: "Starting a business with your spouse or significant other is an exciting but delicate process and requires a great deal...",
    image: "/placeholder.svg?height=200&width=300",
    categories: ["Design", "Research"],
    link: "#"
  },
